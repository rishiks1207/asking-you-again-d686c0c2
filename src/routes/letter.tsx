      ...
      >
        ...
        <div className="space-y-5 text-lg leading-relaxed text-ink sm:text-xl" style={{ fontFamily: "var(--font-serif)" }}>
          ...
          <p>
            ...
            words feel big enough. So I'll just say it plainly: <em>I'm sorry.</em> I made a promise that i wouldn't give up on us, no matter what happens.Thus here I am. I'm not gonna give up that easily. All the fights nd what not convo we had after breakup, was a cry of help. I was yearning for you. every convo, every text, and every interaction mattered to me.
          </p>
          <p className="whitespace-pre-line">
            ...
            cuz I need you beside me like a flower needs the light;{"\n"}
